...
tests/
  ...
  unit/
    test_reader.py         # ingestion/reader.py — 8 casos
    test_cleaner.py        # cleaning/cleaner.py — 12 casos
...
|---|---|---|
| `ingestion/reader.py` | 8 | Ordenação de partições, diretório vazio, arquivo vazio, variantes de null, multi-partição, colunas faltantes |
| `cleaning/cleaner.py` | 12 | Deduplicação, nulls críticos, amount ≤ 0, normalização de endereços, enums inválidos, region numérica, input vazio |
